...
C     
C     Process: e+ e- > ap ap WEIGHTED<=2 @1
C     *   Decay: ap > mu+ mu- WEIGHTED<=1
C     *   Decay: ap > mu+ mu- WEIGHTED<=1
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_ME,+1,-1*IC(1),W(1,1)) ! count 8
      CALL OXXXXX(P(0,1),MDL_ME,-1,-1*IC(1),W(1,2)) ! count 8
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3)) ! count 24
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4)) ! count 24
      ...
      CALL FFV1_3(W(1,5),W(1,7),GC_9,MDL_MAP,FK_MDL_WAP,W(1,9)) ! count 6
      CALL FFV1_3(W(1,5),W(1,8),GC_9,MDL_MAP,FK_MDL_WAP,W(1,10)) ! count 10
      CALL FFV1_3(W(1,6),W(1,7),GC_9,MDL_MAP,FK_MDL_WAP,W(1,11)) ! count 10
      CALL FFV1_3(W(1,6),W(1,8),GC_9,MDL_MAP,FK_MDL_WAP,W(1,12)) ! count 6
      CALL IXXXXX(P(0,5),MDL_MMU,+1,-1*IC(5),W(1,13)) ! count 2
      CALL IXXXXX(P(0,5),MDL_MMU,-1,-1*IC(5),W(1,14)) ! count 2
      CALL OXXXXX(P(0,6),MDL_MMU,+1,+1*IC(6),W(1,15)) ! count 2
      CALL OXXXXX(P(0,6),MDL_MMU,-1,+1*IC(6),W(1,16)) ! count 2
      CALL FFV1_3(W(1,13),W(1,15),GC_9,MDL_MAP,FK_MDL_WAP,W(1,17)) ! count 6
      CALL FFV1_3(W(1,13),W(1,16),GC_9,MDL_MAP,FK_MDL_WAP,W(1,18)) ! count 10
      CALL FFV1_3(W(1,14),W(1,15),GC_9,MDL_MAP,FK_MDL_WAP,W(1,19)) ! count 10
      CALL FFV1_3(W(1,14),W(1,16),GC_9,MDL_MAP,FK_MDL_WAP,W(1,20)) ! count 6
      CALL FFV1_1(W(1,1),W(1,9),GC_9,MDL_ME,FK_ZERO,W(1,21)) ! count 2
      CALL FFV1_1(W(1,1),W(1,10),GC_9,MDL_ME,FK_ZERO,W(1,22)) ! count 4
      CALL FFV1_1(W(1,1),W(1,11),GC_9,MDL_ME,FK_ZERO,W(1,23)) ! count 4
      CALL FFV1_1(W(1,1),W(1,12),GC_9,MDL_ME,FK_ZERO,W(1,24)) ! count 2
      CALL FFV1_1(W(1,2),W(1,9),GC_9,MDL_ME,FK_ZERO,W(1,25)) ! count 2
      CALL FFV1_1(W(1,2),W(1,10),GC_9,MDL_ME,FK_ZERO,W(1,26)) ! count 4
      CALL FFV1_1(W(1,2),W(1,11),GC_9,MDL_ME,FK_ZERO,W(1,27)) ! count 4
      CALL FFV1_1(W(1,2),W(1,12),GC_9,MDL_ME,FK_ZERO,W(1,28)) ! count 2
      CALL FFV1P1N_2(W(1,3), W(1,18), GC_9, TMP(1))
      call CombineAmp(4,
     & (/5,1,9,7/), 
     & (/25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,3), W(1,19), GC_9, TMP(1))
      call CombineAmp(4,
     & (/6,4,12,8/), 
     & (/25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,3), W(1,17), GC_9, TMP(1))
      call CombineAmp(2,
     & (/2,10/), 
     & (/26,27/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,3), W(1,20), GC_9, TMP(1))
      call CombineAmp(2,
     & (/3,11/), 
     & (/26,27/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,4), W(1,18), GC_9, TMP(1))
      call CombineAmp(4,
     & (/17,13,21,19/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,4), W(1,19), GC_9, TMP(1))
      call CombineAmp(4,
     & (/18,16,24,20/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,4), W(1,17), GC_9, TMP(1))
      call CombineAmp(2,
     & (/14,22/), 
     & (/22,23/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,4), W(1,20), GC_9, TMP(1))
      call CombineAmp(2,
     & (/15,23/), 
     & (/22,23/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1_1(W(1,1),W(1,17),GC_9,MDL_ME,FK_ZERO,W(1,29)) ! count 2
      CALL FFV1_1(W(1,1),W(1,18),GC_9,MDL_ME,FK_ZERO,W(1,30)) ! count 4
      CALL FFV1_1(W(1,1),W(1,19),GC_9,MDL_ME,FK_ZERO,W(1,31)) ! count 4
      CALL FFV1_1(W(1,1),W(1,20),GC_9,MDL_ME,FK_ZERO,W(1,32)) ! count 2
      CALL FFV1_1(W(1,2),W(1,17),GC_9,MDL_ME,FK_ZERO,W(1,33)) ! count 2
      CALL FFV1_1(W(1,2),W(1,18),GC_9,MDL_ME,FK_ZERO,W(1,34)) ! count 4
      CALL FFV1_1(W(1,2),W(1,19),GC_9,MDL_ME,FK_ZERO,W(1,35)) ! count 4
      CALL FFV1_1(W(1,2),W(1,20),GC_9,MDL_ME,FK_ZERO,W(1,36)) ! count 2
      CALL FFV1P1N_2(W(1,3), W(1,10), GC_9, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,3), W(1,11), GC_9, TMP(1))
      call CombineAmp(4,
     & (/10,9,12,11/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,3), W(1,9), GC_9, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/34,35/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,3), W(1,12), GC_9, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/34,35/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,4), W(1,10), GC_9, TMP(1))
      call CombineAmp(4,
     & (/14,13,16,15/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,4), W(1,11), GC_9, TMP(1))
      call CombineAmp(4,
     & (/22,21,24,23/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,4), W(1,9), GC_9, TMP(1))
      call CombineAmp(2,
     & (/17,18/), 
     & (/30,31/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,4), W(1,12), GC_9, TMP(1))
      call CombineAmp(2,
     & (/19,20/), 
     & (/30,31/),
