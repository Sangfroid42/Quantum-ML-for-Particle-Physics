...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1_3(W(1,3),W(1,4),GC_9,MDL_MAP, FK_MDL_WAP,W(1,5))
      CALL IXXXXX(P(0,5),MDL_MMU,NHEL(5),-1*IC(5),W(1,4))
      CALL OXXXXX(P(0,6),MDL_MMU,NHEL(6),+1*IC(6),W(1,3))
      CALL FFV1_3(W(1,4),W(1,3),GC_9,MDL_MAP, FK_MDL_WAP,W(1,6))
      CALL FFV1_1(W(1,1),W(1,5),GC_9,MDL_ME, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,3),W(1,6),GC_9,AMP(1))
      CALL FFV1_1(W(1,1),W(1,6),GC_9,MDL_ME, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,3),W(1,5),GC_9,AMP(2))
