...
c************************************
      ...
      GZpu(1)=dcmplx( gu , Zero)
      GZpu(2)=dcmplx( gu , Zero)
      GZpd(1)=dcmplx( gd , Zero)
      GZpd(2)=dcmplx( gd , Zero)
      GZps(1)=dcmplx( gs , Zero)
      GZps(2)=dcmplx( gs , Zero)
      GZpc(1)=dcmplx( gc , Zero)
      GZpc(2)=dcmplx( gc , Zero)
      GZpb(1)=dcmplx( gb , Zero)
      GZpb(2)=dcmplx( gb , Zero)
      GZpt(1)=dcmplx( gt , Zero)
      GZpt(2)=dcmplx( gt , Zero)
      GZpchi(1)=dcmplx( gchi , Zero)
      GZpchi(2)=dcmplx( gchi , Zero)
