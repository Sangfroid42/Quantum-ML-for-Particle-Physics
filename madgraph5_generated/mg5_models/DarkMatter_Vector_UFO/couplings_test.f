...
c
 ...
 25   format( 1x,a10,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(1,11) 'GZpu ', GZpu(1),' ', GZpu(2)
      write(1,11) 'GZpd ', GZpd(1),' ', GZpd(2)
      write(1,11) 'GZps ', GZps(1),' ', GZps(2)
      write(1,11) 'GZpc ', GZpc(1),' ', GZpc(2)
      write(1,11) 'GZpb ', GZpb(1),' ', GZpb(2)
      write(1,11) 'GZpt ', GZpt(1),' ', GZpt(2)
      write(1,11) 'GZpchi ', GZpchi(1),' ', GZpchi(2)
