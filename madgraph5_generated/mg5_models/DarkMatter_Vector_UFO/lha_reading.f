...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,18,bn,dmmass,100d0)
       ...
       call set_it(n,ivalue,value,name,18,bn,dmwidth,1d0)
       call set_it(n,ivalue,value,name,32,bn,zpwidth,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,gchi ,0d0)
       call set_it(n,ivalue,value,name,2,bn,gu ,0d0)
       call set_it(n,ivalue,value,name,3,bn,gd ,0d0)
       call set_it(n,ivalue,value,name,4,bn,gs ,0d0)
       call set_it(n,ivalue,value,name,5,bn,gc ,0d0)
       call set_it(n,ivalue,value,name,6,bn,gb ,0d0)
       call set_it(n,ivalue,value,name,7,bn,gt ,0d0)
      return
      end
