...
c
 ...
 25   format( 1x,a16,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(6,*)  '---------------------'
      write(6,*)
      write(6,11) 'GZpu(L)  =  ', GZpu(1),'GZpu(R)  =  ', GZpu(2)
      write(6,11) 'GZpd(L)  =  ', GZpd(1),'GZpd(R)  =  ', GZpd(2)
      write(6,11) 'GZps(L)  =  ', GZps(1),'GZps(R)  =  ', GZps(2)
      write(6,11) 'GZpc(L)  =  ', GZpc(1),'GZpc(R)  =  ', GZpc(2)
      write(6,11) 'GZpb(L)  =  ', GZpb(1),'GZpb(R)  =  ', GZpb(2)
      write(6,11) 'GZpt(L)  =  ', GZpt(1),'GZpt(R)  =  ', GZpt(2)
      write(6,11) 'GZpchi(L)  =  ', GZpchi(1),'GZpchi(R)  =  ', GZpchi(2)
      write(6,*)
      ...
      write(6,*) '-----------------------------'
      write(6,*)
      write(6,24) 'DMMASS  =  ', DMMASS, 'DMWIDTH    = ', DMWIDTH
      write(6,24) 'ZpMASS  =  ', ZpMASS, 'ZpWIDTH    = ', ZpWIDTH
      write(6,*)
      write(6,*) 'User Model Parameters:'
      write(6,*) '----------------------'
      write(6,24) 'gchi   =  ', gchi 
      write(6,24) 'gu   =  ', gu 
      write(6,24) 'gd   =  ', gd 
      write(6,24) 'gs   =  ', gs 
      write(6,24) 'gc   =  ', gc 
