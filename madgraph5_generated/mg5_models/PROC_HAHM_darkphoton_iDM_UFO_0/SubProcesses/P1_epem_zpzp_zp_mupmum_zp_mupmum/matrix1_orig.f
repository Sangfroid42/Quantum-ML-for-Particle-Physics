...
C     
C     Process: e+ e- > zp zp WEIGHTED<=2 @1
C     *   Decay: zp > mu+ mu- WEIGHTED<=1
C     *   Decay: zp > mu+ mu- WEIGHTED<=1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
     ...
     $    ABS(MDL_MZP*SMALL_WIDTH_TREATMENT)), MDL_WZP)
      ...
      CALL FFV2_4_3(W(1,3),W(1,4),GC_39,GC_48,MDL_MZP, FK_MDL_WZP,W(1
     $ ,5))
      CALL IXXXXX(P(0,5),MDL_MM,NHEL(5),-1*IC(5),W(1,4))
      CALL OXXXXX(P(0,6),MDL_MM,NHEL(6),+1*IC(6),W(1,3))
      CALL FFV2_4_3(W(1,4),W(1,3),GC_39,GC_48,MDL_MZP, FK_MDL_WZP,W(1
     $ ,6))
      CALL FFS1_3(W(1,2),W(1,1),GC_75,MDL_MH, FK_MDL_WH,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,5),W(1,6),W(1,3),GC_64,AMP(1))
      CALL FFS1_3(W(1,2),W(1,1),GC_76,MDL_MHS, FK_MDL_WHS,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,5),W(1,6),W(1,3),GC_61,AMP(2))
      CALL FFV2_4_1(W(1,1),W(1,5),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV2_4_0(W(1,2),W(1,3),W(1,6),GC_39,GC_48,AMP(3))
      CALL FFV2_4_1(W(1,1),W(1,6),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,2),W(1,3),W(1,5),GC_39,GC_48,AMP(4))
